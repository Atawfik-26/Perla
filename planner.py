...
def decompose_task(task):
    ...
    لو حصل أي مشكلة، بترجع المهمة الأصلية كخطوة واحدة.
    """
...
def execute_step(
    ...
    ملحوظة: enable_tools=True هنا (بعد ما كانت من غير تحديد،
    يعني True بالـdefault فعليًا) - بس بنكتبها صراحة عشان
    يبقى واضح إن كل خطوة في الخطة تقدر تستخدم read_file/
    fetch_url لو احتاجت، بالظبط زي الرد العادي في brain.py.
    """
...
عندك أدوات فعلية لو الخطوة دي محتاجة: read_file (قراءة ملف)
و fetch_url (فتح رابط). استخدميهم فعليًا لو الخطوة تستدعي ده.
